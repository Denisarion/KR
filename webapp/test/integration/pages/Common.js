sap.ui.define([
		...
		function getFrameUrl (sHash, sUrlParameters) {
			var sUrl = jQuery.sap.getResourcePath("ControlTaskGrishchenko/ControlTaskGrishchenko/app", ".html");
		...
		return Opa5.extend("ControlTaskGrishchenko.ControlTaskGrishchenko.test.integration.pages.Common", {
			...
			getMockServer : function () {
				return new Promise(function (success) {
					Opa5.getWindow().sap.ui.require(["ControlTaskGrishchenko/ControlTaskGrishchenko/localService/mockserver"], function (mockserver) {
